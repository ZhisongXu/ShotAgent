...
| Paper method | LLM style ↑ | VGG style ↑ | Lab W1 ↓ | Lab SWD ↓ |
|---|---:|---:|---:|---:|
| SA-LUT | 0.3250 ± 0.1333 | 0.8966 ± 0.0322 | 0.0860 ± 0.0477 | 0.0901 ± 0.0497 |
| NLUT | 0.7380 ± 0.0736 | 0.9472 ± 0.0233 | 0.0477 ± 0.0315 | 0.0562 ± 0.0383 |
| **CAP-VSTNet** | **0.7985 ± 0.0666** | **0.9757 ± 0.0107** | **0.0281 ± 0.0164** | **0.0335 ± 0.0215** |
| CanonCGT | 0.5719 ± 0.1516 | 0.9063 ± 0.0383 | 0.0726 ± 0.0378 | 0.0775 ± 0.0420 |
| ShotAgent API Editor Pool | 0.6015 ± 0.1598 | 0.9114 ± 0.0384 | 0.0663 ± 0.0369 | 0.0794 ± 0.0504 |
